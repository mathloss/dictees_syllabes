...
def nouveau_son_3():
    ...
    son1 =  choice(liste_son)
    son2 = choice(liste_son)
    son3 = choice(liste_son)
    global mot_a_trouver
    mot_a_trouver = son1 + son2 + son3
    print(mot_a_trouver)
    engine = pyttsx3.init()
    engine.setProperty('rate',100)
    engine.say(mot_a_trouver)
...
def nouveau_son_4():
    ...
    son2 = choice(liste_son)
    son3 = choice(liste_son)
    son4 = choice(liste_son)
    global mot_a_trouver
    mot_a_trouver = son1 + son2 + son3 + son4
    print(mot_a_trouver)
    engine = pyttsx3.init()
    engine.setProperty('rate',100)
    engine.say(mot_a_trouver)
...
def syllabe_1():
    ...
    syllabe_1_frame.pack(fill="both", expand=1)

    ecoute_frame = Frame(syllabe_1_frame, width=400, height=200, bg="black")
    ecoute_frame.pack(pady=5)

    label_1 = Label(ecoute_frame,text="Ecoute attentivement", font=("Arial",20), bg="black", fg="white")
    label_1.grid(row=0, column=0) 

    bouton_ecoute = Button(ecoute_frame, text="Son",font=("Arial",20), bg="black", fg="white",command=nouveau_son_1)
    bouton_ecoute.grid(row=0, column=1, padx=15)

    bouton_repeter = Button(syllabe_1_frame, text="Répéter le son",font=("Arial",20), bg="black", fg="white",command=repeter_son)
    bouton_repeter.pack(pady=10)

    label_2 = Label(syllabe_1_frame, text="Ta réponse : ", font=("Arial",20), bg="black", fg="white")
    label_2.pack(pady=10)

    reponse_frame = Frame(syllabe_1_frame,width=400, height=200, bg="black")
    ...
    resultat_label = Label(syllabe_1_frame, text="Nul",font=("Arial",20), bg="black", fg="white") 
    resultat_label.pack(pady=10)

    global resultat_label2
    resultat_label2 = Label(syllabe_1_frame, text="TRES NUL",font=("Arial",20), bg="black", fg="white") 
...
def syllabe_2():
    ...
    bouton_ecoute = Button(ecoute_frame, text="Son",font=("Arial",20), bg="black", fg="white",command=nouveau_son_2)
    bouton_ecoute.grid(row=0, column=1, padx=15)

    bouton_repeter = Button(syllabe_2_frame, text="Répéter le son",font=("Arial",20), bg="black", fg="white",command=repeter_son)
    bouton_repeter.pack(pady=10)
...
def syllabe_3():
    ...
    bouton_ecoute = Button(ecoute_frame, text="Son",font=("Arial",20), bg="black", fg="white",command=nouveau_son_3)
    bouton_ecoute.grid(row=0, column=1, padx=15)
...
def syllabe_4():
    ...
    bouton_ecoute = Button(ecoute_frame, text="Son",font=("Arial",20), bg="black", fg="white",command=nouveau_son_4)
    bouton_ecoute.grid(row=0, column=1, padx=15)
...
def choix():
    ...
    s1_button = Button(choix_frame, text="1 syllabe", font=("Arial",20), bg="black",fg="white", command=syllabe_1) 
    s1_button.pack(pady=5)
...
syllabe_menu.add_command(label="1 syllabe", command=syllabe_1)
...
# on crée les frames
syllabe_1_frame = Frame(root, width=400, height=500, bg="black")
syllabe_2_frame = Frame(root, width=400, height=500, bg="black")
syllabe_3_frame = Frame(root, width=400, height=500, bg="black")
syllabe_4_frame = Frame(root, width=400, height=500, bg="black")
choix_frame = Frame(root, width=400, height=500, bg="black")
